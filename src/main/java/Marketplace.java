...
public class Marketplace{
    ...
    public Marketplace(String username, String password){
        try{
            //this.conn = DriverManager.getConnection("jdbc:mysql://localhost/",username,password);
            this.conn = DriverManager.getConnection("jdbc:mariadb://localhost/", username, password);

            String sql = "USE OnlineShop";
    ...
    public void createProduct() {
        ...
        String productQuery = "INSERT INTO Products (ProductID, ProductName, Description, Price, Category) VALUES (?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(productQuery)) {
            ...
            if (affectedRows > 0) {
                System.out.println("Product created successfully. The Product ID is: " + productId);
